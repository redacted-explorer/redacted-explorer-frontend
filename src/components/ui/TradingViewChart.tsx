...
import { Bar, ChartingLibraryWidgetOptions, IBasicDataFeed, ResolutionString, SearchSymbolResultItem, widget } from "@/public/charting_library/charting_library";
    ...
    useEffect(() => {
        ...
        const datafeed: IBasicDataFeed = {
            onReady: (callback) => {
                ...
                setTimeout(() =>
                    callback({
                        ...
                        supports_time: true,
                        supported_resolutions: ["1" as ResolutionString, "5" as ResolutionString, "15" as ResolutionString, "60" as ResolutionString, "4h" as ResolutionString, "D" as ResolutionString, "W" as ResolutionString]
                    })
                );
            },
            searchSymbols: async (
                ...
                const symbols: Promise<SearchSymbolResultItem>[] = results.map(async (result) => {
            ...
            getBars: async (
                ...
                const url = `https://events.intear.tech/api/ohlc?token=${symbolInfo.ticker!
        ...
        const widgetOptions: ChartingLibraryWidgetOptions = {
            ...
            custom_themes: {
                ...
                dark: {
                    color1: ["#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#076041", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97"],
                    color2: ["#ffffff", "#ffffff", "#ffffff", "#00ec97", "#eeeeee", "#dddddd", "#cccccc", "#bbbbbb", "#aaaaaa", "#999999", "#888888", "#777777", "#666666", "#555555", "#444444", "#333333", "#222222", "#000000", "#111111"],
                    color3: ["#f85151", "#f85151", "#f85151", "#f85151", "#f85151", "#f85151", "#f85151", "#f85151", "#f85151", "#f85151", "#f85151", "#f85151", "#f85151", "#f85151", "#f85151", "#f85151", "#f85151", "#f85151", "#f85151"],
                    color4: ["#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97"],
                    color5: ["#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97"],
                    color6: ["#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97"],
                    color7: ["#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97", "#00ec97"],
                    white: '#ffffff',
                    black: '#000000',
                },
            }
...
async function getMetadata(account_id: string): Promise<{ name: string, symbol: string, decimals: number, icon: string, spec: string, reference: string | null, reference_hash: string | null }> {
